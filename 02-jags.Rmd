...
### Example 2 (continued): Two-Sample Problem
The file `Examples/Example_1/example_2b.jags` reproduces the code for the two-sample problem, except that it excludes the lines that define the values of `mu1`, `mu2`, and `sigma2`. Instead, you will pass the values of these parameters from `R` into JAGS.
