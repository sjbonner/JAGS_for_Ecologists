...
We can also look at the summary information graphically using the functions in the `ggmcmc` package. The plotting functions in the package require that the output from JAGS first be processed with the functions in `ggs()`. For example:
```{r}
## Load package
library(ggmcmc)
